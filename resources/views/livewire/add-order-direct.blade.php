<div class="p-5 edit_content">
    <div class="relative w-full h-6 pb-2 mb-7 modal-header">
        <h2 class="absolute top-0 left-0 p-2 text-3xl font-bold text-left text-red-500">Create Order </h2>
    </div>
    ...
    <div class="table p-1 mt-10">
        ...
        <div class="table-row m-1 element">
            <label class="table-cell p-2 text-gray-400" for="order_customer_name"><strong>Customer: </strong></label>
            <select wire:model="o_customer_name" class="table-cell w-64 p-1 m-1 border border-gray-400 rounded-md" type="text" name="order_customer_name">
    ...
    <div class="text-end actions">
        <button wire:click="create" class="px-2 pt-1 m-1 mt-0 text-2xl text-white align-bottom bg-blue-500 rounded-md leading-0">
